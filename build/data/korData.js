...
function addAlphabetData(alphabet, width, height, pixelPositions) {
    const shapeData = alphabetData[alphabet];
    const pixels = pixelPositions.map(pixel => pixel.split("_").map(pos => +pos));
    ...
    if (!shapeData)
        return;
    shapeData.set(`${width}_${height}`, pixels);
}
function addDatas(shapes, pos, xOffset, yOffset, width, height) {
    for (const shape of shapes) {
        ...
        if (!shapeData)
            return;
        for (const alphabet of koreanAlphabets) {
            const key = `${pos}_${alphabet}`;
            if (shapeData.has(key))
                continue;
            const pixelPositions = alphabetData[alphabet].get(`${width}_${height}`);
            if (!pixelPositions)
                continue;
            const shiftedPixels = pixelPositions.map(([x, y]) => `${Math.min(7, x + xOffset)}_${Math.min(7, y + yOffset)}`);
...
function addData(shape, pos, alphabet, pixels) {
    ...
    if (!shapeData)
        return;
    const key = `${pos}_${alphabet}`;
    shapeData.set(key, pixels.map(pixel => pixel.split("_").map(pos => +pos)));
}
// addAlphabetData
(() => {
    // ㄱ
    ...
    addAlphabetData("ㄹ", 5, 3, ["1_1", "2_1", "3_1", "4_1", "5_1", "1_2", "1_3", "2_3", "3_3", "4_3", "5_3"]);
    ...
    addAlphabetData("ㅆ", 5, 3, ["1_1", "2_1", "1_2", "2_2", "3_2", "1_3", "2_3", "3_3", "1_4", "2_4", "3_4", "1_5", "3_5"]);
...
(() => {
    ...
    addDatas(["c2v1c2c3", "c2v1c3c2", "c2v1c3c3", "c2v2c2c3", "c2v2c3c2", "c2v2c3c3", "c2v3c2c3", "c2v3c3c2", "c2v3c3c3"], 2, 0, 3, 3, 4);
    addDatas(["c2v1c2c3", "c2v1c3c2", "c2v1c3c3", "c2v2c2c3", "c2v2c3c2", "c2v2c3c3", "c2v3c2c3", "c2v3c3c2", "c2v3c3c3"], 3, 3, 3, 3, 4);
})();
...
(() => {
    ...
    addDatas(["c3v1c5", "c3v2c5", "c3v3c5"], 2, 1, 3, 4, 4);
    addDatas(["c3v1c2c3", "c3v1c3c2", "c3v1c3c3", "c3v2c2c3", "c3v2c3c2", "c3v2c3c3", "c3v3c2c3", "c3v3c3c2", "c3v3c3c3"], 2, 0, 3, 3, 4);
    addDatas(["c3v1c2c3", "c3v1c3c2", "c3v1c3c3", "c3v2c2c3", "c3v2c3c2", "c3v2c3c3", "c3v3c2c3", "c3v3c3c2", "c3v3c3c3"], 3, 3, 3, 3, 4);
})();
...
(() => {
    ...
    addDatas(["c5v1c2c3", "c5v1c3c2", "c5v1c3c3", "c5v2c2c3", "c5v2c3c2", "c5v2c3c3", "c5v3c2c3", "c5v3c3c2", "c5v3c3c3"], 2, 0, 4, 3, 3);
    addDatas(["c5v1c2c3", "c5v1c3c2", "c5v1c3c3", "c5v2c2c3", "c5v2c3c2", "c5v2c3c3", "c5v3c2c3", "c5v3c3c2", "c5v3c3c3"], 3, 3, 4, 3, 3);
})();
console.log(data);
export default data;
